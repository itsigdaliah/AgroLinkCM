...
function AddProductModal({ isOpen, onClose, onSubmit, formData, onChange }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-[90%] max-w-2xl p-6 relative max-h-[90vh] overflow-hidden flex flex-col">
        <button
          onClick={onClose}
        ...
        <form onSubmit={onSubmit} className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="mt-6 pt-4 border-t border-gray-200 sticky bottom-0 bg-white flex justify-end space-x-3">
            <button
              type="button"
              onClick={onClose}
